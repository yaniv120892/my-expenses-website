...
export default function SubscriptionEvidenceDialog({
  ...
  const gaps = evidence ? daysBetweenCharges(evidence.recentCharges) : [];
        ...
        {!subscription ? null : !evidence ? (
          ...
          <Stack spacing={2.5} sx={{ mt: 1 }}>
            ...
            >
              ...
              />
              <Fact label="Charges matched" value={`${evidence.chargeCount}`} />
              <Fact
                label="Window analyzed"
                value={`${formatDay(evidence.analyzedFrom)} → ${formatDay(evidence.analyzedTo)}`}
              />
              <Fact label="Merchant key" value={evidence.merchantKey} />
            </Box>
            ...
            <Box>
              ...
              <Box sx={{ overflowX: 'auto' }}>
                <Table size="small">
                  ...
                  <TableBody>
                    {evidence.recentCharges.map((charge, index) => (
